    ...
    return (
        <div className="page">
            ...
            <div className='investor-dashboard'>
                            ...
                            loanApplications.map((application) => (
                                <div key={application.id} className='application-card'>
                                    ...
                                    <div className="button-group">
                                        ...
                                        <button className='bid-button' onClick={() => router.push("/bidding/?id=" + application.id)}>
                                            Bid
                                        </button>
                                    </div>
                                </div>
                ...
                {/* Top right box: Finalized Bids */}
                <div className='finalized-bids-box'>
                    <h2 className="box-title">View your Finalized Bids</h2>
                    <button className='payment-button' onClick={handleFinalizedBidsPage}>
                        Go to Finalized Bids Page
                    </button>
                </div>
            </div>
        </div>
