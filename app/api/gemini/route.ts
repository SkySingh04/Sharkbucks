...
//     // const { question, koiaur } = body.;
//     // console.log('Question', question);
//     // console.log('koiaur', koiaur);
//     const template=`
//     Context:
//     Scheme s 
//     MSMEs
...
//     const userInput = template; // Replace with the user input
...
//     return NextResponse.json({ message: userInput });
//   } catch (error) {
//     console.error(error);
